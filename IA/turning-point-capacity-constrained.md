...
- **Next action:** per the frozen rule (§5), the capacity-constrained class is NOT re-litigated — micro-cap long-only and small-cap options close with it; the fork has returned to stop. The liquid-market negative record plus this probe stand as the complete measured picture. Re-opening any lane is possible only as an explicit amendment of the frozen rule by the user — an amendment, not a continuation.