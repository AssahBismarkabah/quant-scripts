...
- **Next action:** fork has returned to stop; the remaining registered lanes (micro-cap long-only, small-cap options) are untouched by this result — re-opening either is a fresh decision for the user, not an automatic continuation. The liquid-market negative record plus this probe stand as the complete measured picture.