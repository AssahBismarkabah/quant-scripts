-- Post-graduation (PumpSwap AMM) trade aggregates for tokens that graduated 2026-09-01.
...
-- All 2026-09-01 graduates' pools were created in the Sep block month partition.
...
pools AS (
  ...
  WHERE evt_block_date BETWEEN DATE '2026-09-01' AND DATE '2026-09-01' + INTERVAL '7' DAY
