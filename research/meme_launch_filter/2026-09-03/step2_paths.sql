...
pools AS (
  ...
  WHERE evt_block_date BETWEEN DATE '2026-09-03' AND DATE '2026-09-03' + INTERVAL '1' DAY
...
buys AS (
  ...
  WHERE b.evt_block_date BETWEEN DATE '2026-09-03' AND DATE '2026-09-03' + INTERVAL '1' DAY
...
sells AS (
  ...
  WHERE s.evt_block_date BETWEEN DATE '2026-09-03' AND DATE '2026-09-03' + INTERVAL '1' DAY
