-- Post-graduation (PumpSwap AMM) trade aggregates for tokens that graduated 2026-09-04.
...
-- All 2026-09-04 graduates' pools were created in the Sep block month partition.
...
pools AS (
  ...
  WHERE evt_block_date BETWEEN DATE '2026-09-04' AND DATE '2026-09-04' + INTERVAL '7' DAY
...
buy_sides AS (
  ...
  WHERE b.evt_block_date >= DATE '2026-09-04'
...
sell_sides AS (
  ...
  WHERE s.evt_block_date >= DATE '2026-09-04'
