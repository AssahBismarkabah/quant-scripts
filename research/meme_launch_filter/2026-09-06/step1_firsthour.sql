-- First-hour trade aggregates per token created 2026-09-06, split creator vs non-creator
WITH launches AS (
...
trade_sides AS (
  ...
  WHERE t.block_time >= TIMESTAMP '2026-09-06 00:00:00'
    AND t.block_time < DATE '2026-09-06' + INTERVAL '1' DAY
