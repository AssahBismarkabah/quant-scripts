...
- [ES Previous-Day Value-Area Opening-State Study](../IA/es-value-area-opening-state-research-spec.md) — **DISCONFIRMED** (2026-09-04): corrected 50%/50% scale-out probe on ES one-minute bar-close profile proxy; OOS base net −464.63 points, stress net −646.63, PF 0.691/0.595; all performance gates failed.
- [CBOT Six-Part Market Profile Source Audit](../IA/cbot-market-profile-source-audit.md) — full six-part audit (2026-09-01): the guide supports a conditional value/continuation research question but supplies no verified ES/MES entry system; its unavailable LDB participant-volume data is a material capability gap.
- [Mechanism-First Edge Audit](../IA/mechanism-first-edge-audit.md) — **CONSOLIDATED FINAL RESULT** (2026-09-08): the five-lane summary covering the exhausted public-data strategy search plus A1-A4 mechanism audits; no lane produced a viable mechanism or authorized a trading test.
- [Deep Research Candidate Reconciliation](../IA/deep-research-candidate-reconciliation.md) — COMPLETE (2026-09-12): all 30 deep-research candidates reconciled against the closed project record; B5 niche-ETF NAV dislocation and B15 spin-offs remain interesting but unverifiable; no backtest is authorized.
- [B15 Spin-Off Feasibility Audit](../IA/spin-off-feasibility-audit.md) — STARTED (2026-09-17): source and observability audit only; no trading test authorized. [Feasibility plan](../research/spin-offs/phase_b_feasibility_plan.md).
- [Spin-Off Candidate Registry](../research/spin-offs/phase_b_candidate_registry.md) — checkpoint: three confirmed examples, none currently passes the mechanism gates.
- [S04 Spin-Off Index-Exclusion Amendment](../IA/s04-spin-off-index-exclusion-amendment.md) — COMPLETE: NO VIABLE MODERN EXECUTABLE EVENT FOUND (2026-09-17); narrow corporate-action-specific index-exclusion chain, not a reopening of broad index rebalancing.
- [B5 Niche-ETF NAV Dislocation Audit](../IA/niche-etf-nav-dislocation-phase-b5-audit.md) — COMPLETE: UNVERIFIABLE / CLOSED FAMILY OVERLAP (2026-09-17); stale-underlying NAV lacks executable intraday valuation, while AP impairment duplicates A1.
- B5 implementation: `src/quant_scripts/niche_etf_nav/valuation.py` provides coverage-aware bid/ask basket valuation only; tests are in `tests/test_niche_etf_nav.py`.
- B5 frozen universe and audit command: [`research/niche-etf-nav/frozen_universe.csv`](../research/niche-etf-nav/frozen_universe.csv) and [`research/niche-etf-nav/Makefile`](../research/niche-etf-nav/Makefile).
- [Phase A: Forced-Flow and Settlement Mechanism Audit](../IA/forced-flow-settlement-phase-a-audit.md) — COMPLETE (2026-09-06): 12 concrete mechanisms audited against primary sources and six gates; no candidate passed, so no Phase B or C test is authorized.
- [Phase A2: Capacity-Constrained Securities Mechanism Audit](../IA/capacity-constrained-securities-phase-a-audit.md) — COMPLETE (2026-09-06): 15 concrete mechanisms audited against primary sources and six gates; no candidate passed, so no Phase B or C test is authorized.
- [Phase A3: Specialist Information Mechanism Audit](../IA/specialist-information-phase-a-audit.md) — COMPLETE (2026-09-06): 12 concrete mechanisms audited against primary sources, lawful-access constraints, and six gates; no candidate passed, so no Phase B or C test is authorized.
- [Phase A4: Fragmented and Operational Markets Mechanism Audit](../IA/fragmented-operational-phase-a-audit.md) — COMPLETE (2026-09-08): 12 concrete mechanisms audited against primary operational sources and six gates; no candidate passed, so no Phase B or C test is authorized.
- [ES Value-Area Phase 0](../research/es-value-area/outputs/phase0_coverage.json) — generated coverage audit for the frozen ES study; implementation is isolated under `src/quant_scripts/es_value_area/`.
- [Earnings-Anchored VWAP Research Gate](../IA/earnings-anchored-vwap-research-gate.md) — proposed daily historical falsification; Phase 0 release-timing GATE FAILED (2026-08-24, second correction): three genuine harness bugs in the free SEC EDGAR audit (exhibit enumeration, candidate ordering, 10-Q/10-K exhibit coverage) were found and fixed; the corrected audit verified 96/100 with agreement 90/96 = 0.9375 (6 template-side session-label errors) — still below both frozen bars (100 rows, 95%) — so the default probe stays blocked. Because free data cannot reach the gate, the bounded daily OOS falsification was executed on owned data under two recorded free-data allowances (2026-08-24): the frozen `label` construction and a label-free `next_open` anchor; **both versions disconfirmed on every OOS gate for both sides** (net base OOS mean −30 to −45 bps; worse than an earnings-gap hold; VWAP weighting adds nothing). Verdict recorded: DISCONFIRMED. Free data paths (Yahoo, then EDGAR) are exhausted; a paid point-in-time earnings-time source would only relabel the same already-disconfirmed construction, so no purchase is justified.
