...
- [Short Vol / VRP](../strategies/vol-risk-premium/VOL_RISK_PREMIUM.md) - CANDIDATE spec only (2026-08-08): no probe approved; owned-data VRP testable, premium decayed (Dew-Becker 2025), event version needs paid IV data
